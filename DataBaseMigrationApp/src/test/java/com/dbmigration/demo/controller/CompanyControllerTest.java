...
public class CompanyControllerTest {
    ...
    @Test
    @DisplayName("Test for fetching company from postgresql database.")
    public void givenCompanyId_whenGetCompanyFromPostgresqlDb_thanReturnCompany() throws Exception {
        BDDMockito.given(companyService.getCompanyFromPostgresql(BDDMockito.anyInt())).willReturn(company);

        ResultActions response = mockMvc.perform(MockMvcRequestBuilders.get("/company/getCompanyFromPostgresql/{companyId}", company.getCompanyId()));
